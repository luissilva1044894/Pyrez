...
class SmiteAPI(BaseSmitePaladins):
    ...
    def getPlayer(self, player, portalId=None):
        return self.__request_method__('getplayer', SmitePlayer, params=[player, portalId] if portalId else [player], raises=PlayerNotFound("Player doesn't exist or it's hidden"))
