...
<details markdown="1">
<summary>If you use Pyrez in your project, you can include this badge in your project's Readme to let people know that you are using <code>Pyrez</code>! The markdown code is below...</summary>
